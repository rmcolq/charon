...
#pragma omp critical(pos_push)
        ...
        PLOG_VERBOSE << "Add to g_pos results in g_pos size " << pos.size() << " and g_neg size " << neg.size()
                     << " with status " << pos_complete << neg_complete << complete;
        return complete;
    };
...
#pragma omp critical(neg_push)
        ...
        PLOG_VERBOSE << "Add to g_neg results in g_pos size " << pos.size() << " and g_neg size " << neg.size()
                     << " with status " << pos_complete << neg_complete << complete;
        return complete;
    };
