...
void setup_dehost_subcommand(CLI::App &app) {
    ...
    dehost_subcommand->add_option("-e,--extract", opt->category_to_extract,
    ...
    dehost_subcommand
            ->add_option("--host_unique_prop_lo_threshold", opt->host_unique_prop_lo_threshold,
                         "Require non-host reads to have unique host proportion below this threshold for classification.")
            ->type_name("INT")
            ->capture_default_str();
    ...
    dehost_subcommand
            ...
            ->capture_default_str();
    dehost_subcommand
            ->add_option("--min_probability_diff", opt->min_prob_difference,
                         "Minimum difference between the probability found in each category.")
            ->type_name("FLOAT")
            ->capture_default_str();
